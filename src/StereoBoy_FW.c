...
#include "lib/adv/adv.h"
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include "hw_config.h"
#include "hardware/i2c.h" // Make sure this is included
...
{
    stdio_init_all();
    sleep_ms(10000); // Wait for USB Serial to connect

    printf("Initializing Hardware...\r\n");

    // 1. Initialize I2C1 at 100 kHz or 400 kHz
    i2c_init(i2c0, 400 * 1000); // The ADV7180 supports 100k or 400k

    // 2. Set GPIO functions to I2C
    gpio_set_function(PIN_I2C0_SDA, GPIO_FUNC_I2C);
    gpio_set_function(PIN_I2C0_SCL, GPIO_FUNC_I2C);

    // printf("I2C Initialized. Starting ADV7180 config...\r\n");

    // 4. Now it is safe to write to the bus
    // adv7180_init();
